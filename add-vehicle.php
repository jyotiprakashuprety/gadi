			...
			<div>
				...
				<div style="width: 48%; float: left;" class="radio">
					...
					<div class="box">
						...
						<input type="radio" name="type" value="0" checked> Petrol<br>
						<input type="radio" name="type" value="1"> Diesel<br>
						<input type="radio" name="type" value="2" >Electric<br><br>
						<input type="radio" name="type" value="3" > Hybrid<br><br>
					</div>
					<div class="box">
